...
const routes: Routes = [
    ...
    {
        path: 'myoffers',
        loadChildren: () => import('./pages/myoffers/myoffers.module').then(m => m.MyOffersPageModule)
    },
    {
        path: 'orderdetails',
    ...
    {
        path: 'allrequests',
        loadChildren: () => import('./pages/allrequests/allrequests.module').then(m => m.AllrequestsPageModule)
    },
];
